...
# 1. Load dataset_low_scatter.csv
csv_path = "dataset_low_scatter.csv"
...
actual_vs_pred_path = os.path.join(
    output_dir, "actual_vs_predicted_low_scatter.png"
)
...
try:
    ...
    subprocess.run(
        [
            ...
            "commit",
            "-m",
            f"Add Actual vs Predicted and Residuals plots (MAE: {mae:.2f}, MSE: {mse:.2f}, R2: {r2:.3f})",
        ],
        check=True,
    )
